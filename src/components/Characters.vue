...
export default {
    ...
    methods:{
        getCaraters(){
            /* 
                TODO: Añadir la lógica necesaria para cargar los datos de los personajes de Rick and Morty atacando el endpoint
                https://rickandmortyapi.com/api/character y usando Axios*
